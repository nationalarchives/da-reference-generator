...
object Dependencies {
  ...
  lazy val awsSdkDynamoDbV2 = "software.amazon.awssdk" % "dynamodb" % "2.21.29"
  lazy val awsSdkDynamoDbV1 = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.12.595"
  ...
  lazy val logback = "ch.qos.logback" % "logback-classic" % "1.4.12"
